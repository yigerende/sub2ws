...
func (h *SettingHandler) GetSettings(c *gin.Context) {
	...
	payload := dto.SystemSettings{
		...
		CPAWSQueueLimitPerConn:                                 settings.CPAWSQueueLimitPerConn,
		CPAWSPoolTargetUtilization:                             settings.CPAWSPoolTargetUtilization,
		CPAWSMaxRequestsPerConn:                                settings.CPAWSMaxRequestsPerConn,
		CPAWSMaxConnAgeSeconds:                                 settings.CPAWSMaxConnAgeSeconds,
		CPAWSDialTimeoutSeconds:                                settings.CPAWSDialTimeoutSeconds,
		CPAWSReadTimeoutSeconds:                                settings.CPAWSReadTimeoutSeconds,
		CPAWSWriteTimeoutSeconds:                               settings.CPAWSWriteTimeoutSeconds,
		CPAWSPrewarmCooldownMS:                                 settings.CPAWSPrewarmCooldownMS,
		CPAWSRetryBackoffInitialMS:                             settings.CPAWSRetryBackoffInitialMS,
		CPAWSRetryBackoffMaxMS:                                 settings.CPAWSRetryBackoffMaxMS,
		CPAWSRetryJitterRatio:                                  settings.CPAWSRetryJitterRatio,
		CPAWSRetryTotalBudgetMS:                                settings.CPAWSRetryTotalBudgetMS,
		CPAWSEventFlushBatchSize:                               settings.CPAWSEventFlushBatchSize,
		CPAWSEventFlushIntervalMS:                              settings.CPAWSEventFlushIntervalMS,
