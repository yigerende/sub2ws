...
const (
	...
	SettingKeyCPAWSQueueLimitPerConn                             = "cpa_ws_queue_limit_per_conn"
	SettingKeyCPAWSPoolTargetUtilization                         = "cpa_ws_pool_target_utilization"
	SettingKeyCPAWSMaxRequestsPerConn                            = "cpa_ws_max_requests_per_conn"
	SettingKeyCPAWSMaxConnAgeSeconds                             = "cpa_ws_max_conn_age_seconds"
	SettingKeyCPAWSDialTimeoutSeconds                            = "cpa_ws_dial_timeout_seconds"
	SettingKeyCPAWSReadTimeoutSeconds                            = "cpa_ws_read_timeout_seconds"
	SettingKeyCPAWSWriteTimeoutSeconds                           = "cpa_ws_write_timeout_seconds"
	SettingKeyCPAWSPrewarmCooldownMS                             = "cpa_ws_prewarm_cooldown_ms"
	SettingKeyCPAWSRetryBackoffInitialMS                         = "cpa_ws_retry_backoff_initial_ms"
	SettingKeyCPAWSRetryBackoffMaxMS                             = "cpa_ws_retry_backoff_max_ms"
	SettingKeyCPAWSRetryJitterRatio                              = "cpa_ws_retry_jitter_ratio"
	SettingKeyCPAWSRetryTotalBudgetMS                            = "cpa_ws_retry_total_budget_ms"
	SettingKeyCPAWSEventFlushBatchSize                           = "cpa_ws_event_flush_batch_size"
	SettingKeyCPAWSEventFlushIntervalMS                          = "cpa_ws_event_flush_interval_ms"
