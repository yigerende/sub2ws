export default {
    accounts: {
      ...
      wsEnabled: '已开启',
      wsDisabled: '未开启',
      cpaWsGlobal: 'CPAWS（全局）',
      cpaWsAccount: 'CPAWS（账号）',
      ...
      openai: {
        ...
        cpaWs: 'CPA WS 执行逻辑',
        cpaWsDesc: '开启后该账号使用 CPA/CLIProxyAPI-Pro 风格的 WS 会话池、预热、会话亲和和坏连接重建；关闭后完全保持 Sub2API 当前 WS 逻辑。',
        cpaCacheAffinity: 'CPA 缓存亲和',
        cpaCacheAffinityDesc: '让该账号参与 CPA 缓存亲和池；关闭后仍使用 Sub2API 原账号调度。',
        cpaPrefixHeat: '共享前缀热度',
        cpaPrefixHeatDesc: '新会话优先选择成功处理过相同长前缀的可用账号。',
        cpaAffinityMode: '亲和策略',
        cpaAffinityModeDesc: '控制亲和账号繁忙时优先首字还是优先缓存。',
        cpaAffinityFirstToken: '首字优先',
        cpaAffinityBalanced: '均衡（推荐）',
        cpaAffinityCacheFirst: '缓存优先',
